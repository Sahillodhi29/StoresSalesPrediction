...
class DataTransformation:
    ...
    def initaite_data_transformation(self):
        try:
            ...
            train_arr = pd.DataFrame(np.c_[input_feature_train_arr, np.array(target_feature_train_df)])
            test_arr = pd.DataFrame(np.c_[input_feature_test_arr, np.array(target_feature_test_df)])

            train_arr.to_csv(r'notebooks\data\final_train',index=False)
            test_arr.to_csv(r'notebooks\data\final_test',index=False)
